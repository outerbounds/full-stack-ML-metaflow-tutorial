...
class FeatureEncoder:
    NAME = "grid"
    FEATURE_LIBRARIES = {"python-geohash": "0.8.5", "tensorflow-base": "2.6.0"}
    CLEAN_FIELDS = [
        "pickup_latitude",
        "pickup_longitude",
        "dropoff_latitude",
    ...
    def encode(cls, table):
        ...
        multi_hot = IntegerLookup(
            vocabulary=list(range(NUM_HASH_BINS)), output_mode="multi_hot", sparse=True
        )
